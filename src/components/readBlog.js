  ...
  return(
    ...
    <div className="position-absolute" style={{zIndex:99,top:"50%",left:"2%"}}>
      <div id="wrapperShare">
        ...
        <a className="btn shareBtn fs-3" href="https://www.facebook.com/sharer/sharer.php?u=https://blogpro-sooty.vercel.app/blog/horizontal-pixel-span" id="a"><i className="fa-brands fa-facebook"></i></a>
        <a className="btn shareBtn fs-3" href="https://www.linkedin.com/sharing/share-offsite/?url=https://blogpro-sooty.vercel.app/blog/horizontal-pixel-span" id="b"><i className="fa-brands fa-linkedin"></i></a>
        <a className="btn shareBtn fs-3" href="http://twitter.com/share?text=Horizontal Pixel Span Algorithm &url=https://blogpro-sooty.vercel.app/blog/horizontal-pixel-span" id="c"><i className="fa-brands fa-twitter"></i></a>
      </div>
    </div>

    <label className="dbtn">
      <input type="checkbox" id="dmode" defaultChecked={toggle} onChange={(e)=>{setToggle(!toggle)}}/>
    ...
    <HelmetProvider>
      ...
      <header className="container my-5">
        <h1 className="display-3 fw-bold"> Horizontal Pixel Span Algorithm <span className="d-block fw-light">using Python</span></h1>
      ...
      <main className="container my-5 fs-5">
        <p className="my-3">
          Finally you found it!!! Congrats🥳. It was difficult.
          But hey, now you are here and let me guide you.
        </p>
        <p className="my-3">
          So, Horizontal Pixel Span alogrithm also known as Scanline Seed Fill algorithm.
          Non-recursive, optimal, faster, compare to Flood-Fill and Boundary-Fill algorithms. Also has advantages of both the Scanline algorithm and the seed fill algorithms.
          Now, don't get it confused by Scan Fill algorithm
          they may sound same but the aproaches are quite different.

        </p>
        <p className="my-4">
          Algorithm can be broken down in these following steps
        </p>
        ...
        <p className="my-4 mb-5">
          Inside the Loop, You need to follow these steps
        </p>
            ...
            <div className="col-7 bg-dark text-light p-3 rounded boxShadow">
                <div className="tab-content" id="nav-tabContent">
                  ...
                  <p>
                    ...
                    because if we do that we need to store the value (x,y) in a temporary variable.
                    Instead of doing that we can simply pop the the element at the end of the loop.
                  </p>
                  </div>
                  <div className="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                  <p>
                    So, basically in here we will try to find the right most part of the current (x,y) coordinate
                    i.e "x+1" till we hit the boundary or the boundary color.
                  </p>
                  </div>
                  <div className="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">
                  <p>
                    In this step we have to look for both up and down (x,y+1 and x,y-1) for any pixel spans.
                    And push those to stack or push there left most positon to stack, which you have to do anyways.
                  </p>
                  </div>
                  <div className="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
                    <p>
                      Finally draw or plot he pixel in the current span.
                      End Loop
                    </p>
                  </div>
                </div>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 bg-dark text-light p-4 rounded boxShadow">
            <p>
              Here <strong>S</strong> being are seed or (x,y) point will be sent to the function where we
              will or the function that we wrote will find the left most position of the Seed.
              In our case it'll be <strong>A</strong> and <strong>A</strong> will be pushed into to the stack.
              After that during our Loop we will check for both up and down pixel span and send
              there seed(x,y) to the funtion to find there left most position and push the return value to the stack
            </p>
          </div>
        </div>
        ...
        <p className="text-lead fst-italic text-info">
          ...
          <a className="btn btn-primary mx-3" href="https://github.com/zebra76966/rtl818eus">GitHub</a>
        </p>
        <p className="py-3">
          We are going to use following modules/packages
        </p>
          <ol className="list-group list-group-numbered ms-md-5 mt-2">
            <li className="list-group-item-warning list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">
                ...
                <button className="btn btn-outline-dark d-block my-2" onClick={(e)=>{navigator.clipboard.writeText(e.target.innerHTML)}}
          ...
          <article>
            ...
            <p className="ms-md-5">
              Here we are creating an polygon similar to example image.
              Technically two objects one a polygon shaped as "H" which is inside an
              Rectangle. Also, we are saving it as an eps file so that it can be used by the pillow.
            </p>
            ...
            <p className="ms-md-5">
              Now we are sending a seed(x,y) to this function to find the left most coordinate/point and return  the coordinate
              which then can be stored into the stack. You can see the full code at the link above for further reference.
            </p>
            ...
            <p className="ms-md-5">
              Final part and the most important part is the loop here we are
              finding the right most point while plotting the pixel and simultaneously
              checking for Horizontal pixel spans up(x, y-1) and down(x, y+1) and calling
              our findL funtion to find there left point and push that into our stack.
            </p>


          </article>
        <hr className="my-5"/>
        <p className="py-5 text-lead text-center">That's it folks. I hope you found this helpful. <span className="text-danger">❤</span></p>
      </main>
