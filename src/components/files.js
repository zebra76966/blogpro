  ...
  return(
      ...
      <div className="boxShadow d-flex justify-content-between my-3 p-2 align-items-center align-middle rounded-pill row" key={fileDat.id}>
        ...
        <div className="col-md-2 col-4 d-flex align-items-center justify-content-end" style={{height:"50px"}}>
          <span className="my-0 lead fs-6 fw-bold px-2">Download</span><a href={"http://localhost:8080/api/download.php?file="+fileDat.fname} className="btn bg-dark btn-lg text-light rounded-circle"><i className="fs-md-1 fs-3 fa-solid fa-file-pdf"></i></a>
        </div>
      </div>
  );
}
