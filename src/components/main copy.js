      ...
      <div className="container mt-5 px-4 overflow-hidden " id="main">
        ...
        <main>
          <div className="row justify-content-around">
            <motion.div
              className="card col-12 col-lg-5 my-3 p-0 rounded"
              style={bshad}
              initial={{ left: "-100%" }}
            ...
            >
              ...
              <div className="card-body bg-dark text-light">
                ...
                <p className="card-text">
                  Old BCA 6<sup>th</sup> Semester examination question paper. Click on download button to go to the
                  download page.
                </p>
                <Link to="/downloads" state={{ grade: "BCA 6" }} className="btn btn-primary">
                  Downloads
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="card-body bg-dark text-light">
                ...
                <p className="card-text">
                  Old BCA 5<sup>th</sup> Semester examination question paper. Click on download button to go to the
                  download page.
                </p>
                <Link to="/downloads" state={{ grade: "BCA 5" }} className="btn btn-primary">
                  Downloads
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="card-body bg-dark text-light">
                ...
                <p className="card-text">
                  Old BCA 4<sup>th</sup> Semester examination question paper. Click on download button to go to the
                  download page.
                </p>
                <Link to="/downloads" state={{ grade: "BCA 4" }} className="btn btn-primary">
                  Downloads
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="card-body bg-dark text-light">
                ...
                <p className="card-text">
                  Old BCA 3<sup>rd</sup> Semester examination question paper. Click on download button to go to the
                  download page.
                </p>
                <Link to="/downloads" state={{ grade: "BCA 3" }} className="btn btn-primary">
                  Downloads
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="card-body bg-dark text-light">
                ...
                <p className="card-text">
                  Old BCA 2<sup>nd</sup> Semester examination question paper. Click on download button to go to the
                  download page.
                </p>
                <Link to="/downloads" state={{ grade: "BCA 2" }} className="btn btn-primary">
                  Downloads
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="card-body bg-dark text-light">
                ...
                <p className="card-text">
                  Old BCA 1<sup>st</sup> Semester examination question paper. Click on download button to go to the
                  download page.
                </p>
                <Link to="/downloads" state={{ grade: "BCA 1" }} className="btn btn-primary">
                  Downloads
                </Link>
              </div>
            </motion.div>
